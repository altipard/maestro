...
class ExtractorStub(object):
    """Extractor service — accepts a file and returns extracted text."""
...
def add_ExtractorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "extractor.Extractor", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("extractor.Extractor", rpc_method_handlers)
